...
Xp=mvnrnd(mup',A,n);
Xn1=mvnrnd(mun',B,p); Xn2=mvnrnd(mun',B,p);
X1=Xp+Xn1'; X2=Xp+Xn2'; X=0.5*(X1+X2);XX=X;
...
save('fin2_ar03_tauB05_N2_m128.mat', 'norm22m', 'normffm' , 'norm22','normff')
...
save('fin2_ar03_tauB05_N2_m256.mat', 'norm22m', 'normffm' , 'norm22','normff')
...
save('fin2_ar03_tauB05_N2_m512.mat', 'norm22m', 'normffm' , 'norm22','normff')
